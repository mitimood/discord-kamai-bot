...
client.on("guildMemberAdd", async member=>{
    ...
    let permissionsTicket = [{id: member.guild.id,type:"role" , "deny":["VIEW_CHANNEL"]},{id:member.id,type:"member", "allow":["VIEW_CHANNEL"]},{id:config.ban_recover.staff_call,"allow":["VIEW_CHANNEL"],type:"role"},{id: config.ban_recover.staff_chat,"allow":["VIEW_CHANNEL"],type:"role"},{id:config.ban_recover.staff_mod, type:"role","allow":["VIEW_CHANNEL"]},{id:config.ban_recover.staff_adm,type:"role","allow":["VIEW_CHANNEL"]}]
    ...
    ticket.send({embed:{title:"Revogação de bans",color:config.color.red, description:"\
